...
eval {
	...
	if ($crit_count) {
		...
		print "CRITICAL: Pattern'".$critpattern."' was ".$notstring."found";
		exit(2);
	} elsif ($warn_count) {
		#print "WARNING: '".$warnpattern."' was ".$notstring." found in '@execute'";
		print "WARNING: Pattern '".$warnpattern."' was ".$notstring."found";
		exit(1);
	}

	#print "OK: nothing obvious in '@execute'";
	print "OK: Both Pattern '".$warnpattern."' and '".$critpattern."' Found!!!";
	exit(0);
};
